...
export default function BedaNamaAdminForm() {
...
<button onClick={() => router.back()} className="block px-4 py-2 text-gray-700 hover:bg-gray-100 rounded">← Kembali</button>
  ...
  <main className="flex-1 p-6 overflow-auto">
    <div className="flex justify-between items-center mb-6">
      <h1 className="text-xl font-bold">📝 Surat Keterangan Beda Nama (Admin)</h1>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div className="bg-white p-4 rounded shadow">
        ...
        <div className="grid grid-cols-2 gap-4 mb-2">
          ...
          {renderInput({ name: "nama_ktp", value: form.nama_ktp, placeholder: "Nama Sesuai KTP", className: "col-span-2 border px-3 py-2 rounded bg-gray-100" })}
      ...
      <div className="bg-white p-4 rounded shadow">
        ...
        <div className="grid grid-cols-2 gap-4 mb-2">
          {renderInput({ name: "nama_di_dokumen", value: form.nama_di_dokumen, placeholder: "Nama di Dokumen", className: "col-span-2 border px-3 py-2 rounded bg-gray-100" })}
          {renderInput({ name: "jenis_dokumen", value: form.jenis_dokumen, placeholder: "Jenis Dokumen", className: "col-span-2 border px-3 py-2 rounded bg-gray-100" })}
        </div>
      </div>
      ...
      <div className="bg-white p-4 rounded shadow">
        ...
        <textarea name="keperluan" value={form.keperluan} disabled className="w-full border px-3 py-2 rounded mb-2 bg-gray-100" rows={3} placeholder="Contoh: Klarifikasi nama untuk keperluan administrasi sekolah" />
